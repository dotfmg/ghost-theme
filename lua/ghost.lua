...
function M.setup()
  ...
  hi("@import.stmt", { fg = c.mauve, italic = true }) -- Import statements, e.g. "import os", "from module import func"
  hi("@class.stmt", { fg = c.red, bold = true }) -- Class definitions, e.g. "class MyClass:"
  hi("@def.stmt", { fg = c.yellow, bold = true }) -- Function definitions, e.g. "def my_function():"
